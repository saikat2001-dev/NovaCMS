                        ...
                        <table @class(['w-full', 'text-left'])>
                            <thead>
                                <tr @class(['bg-slate-50'])>
                                    <th @class(['px-6', 'py-4', 'text-sm', 'font-semibold', 'text-secondary'])>Permission
                                        Name</th>
                                        ...
                                        <td @class(['px-6', 'py-4'])>
                                            <div @class(['flex', 'items-center', 'justify-end', 'gap-2'])>
                                                <form action="{{ route('admin.permissions.destroy', $permission->id) }}"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" @class(['p-1.5', 'rounded-md', 'text-secondary', 'hover:bg-red-50', 'hover:text-red-600', 'transition-colors'])
