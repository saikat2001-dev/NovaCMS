<footer class="bg-white border-t border-border pt-16 pb-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 mb-4">
                    <div class="w-6 h-6 rounded bg-primary flex items-center justify-center text-white font-bold text-sm">C</div>
                    <span class="font-bold text-xl text-text">{{config('app.name')}}</span>
                </div>
                <p class="text-secondary text-sm">
                    Making content management simple, fast, and secure for everyone.
                </p>
            </div>
            <div>
                <h4 class="font-bold text-text mb-4">Product</h4>
             ...
             <div>
                <h4 class="font-bold text-text mb-4">Resources</h4>
                <ul class="space-y-2 text-sm text-secondary">
             ...
             <div>
                <h4 class="font-bold text-text mb-4">Company</h4>
                <ul class="space-y-2 text-sm text-secondary">
        ...
        <div class="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-secondary text-sm">© {{ date('Y') }} {{config('app.name')}}. All rights reserved.</p>
            <div class="flex space-x-6">
                <a href="#" class="text-secondary hover:text-primary"><span class="sr-only">GitHub</span>
                ...
                <a href="#" class="text-secondary hover:text-blue-500"><span class="sr-only">Twitter</span>
