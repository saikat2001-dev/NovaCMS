                        ...
                        <tr @class(['hover:bg-slate-50/50', 'transition-colors', 'group'])>
                            ...
                            <td @class(['px-6', 'py-4'])>
                                <div @class(['flex', 'items-center', 'justify-end', 'gap-2'])>
                                    <a href="{{ route('brand.edit', $brand->id) }}" @class(['p-1.5', 'rounded-md', 'text-secondary', 'hover:bg-slate-100', 'hover:text-primary', 'transition-colors', 'block']) title="Edit">
                                        <svg @class(['w-4', 'h-4']) fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                        </svg>
                                    </a>
                                    <form action="{{ route('brand.delete', $brand->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this brand?');" @class(['inline-block'])>
                                        @csrf
                                        <button type="submit" @class(['p-1.5', 'rounded-md', 'text-secondary', 'hover:bg-red-50', 'hover:text-red-600', 'transition-colors']) title="Delete">
                                            <svg @class(['w-4', 'h-4']) fill="none" stroke="currentColor" viewBox="0 0 24 24">
